...
function Logo() {
  return (
    <div className="flex items-center cursor-pointer shrink-0">
      <span className="text-[28px] font-black italic leading-none">
        <span 
...
function ProjectRow({ project }) {
  ...
  return (
    <div className="flex flex-row items-stretch gap-px">
      ...
      <div className="flex-1 border border-gray-200 dark:border-gray-700 rounded-l-xl p-4 bg-white dark:bg-[#111111]">
      ...
      {/* Middle: Due */}
      <div className="min-w-[150px] border-t border-b border-r border-gray-200 dark:border-gray-700 p-4 bg-white dark:bg-[#111111]">
      ...
      {/* Right: Collaboration */}
      <div className="min-w-[180px] border-t border-b border-r border-gray-200 dark:border-gray-700 rounded-r-xl p-4 bg-white dark:bg-[#111111]">
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#F0F0F0] dark:bg-[#0A0A0A] font-inter transition-colors duration-300 flex flex-col items-center">
      
      {/* ── Navbar── */}
   <div className="w-full h-[138px] bg-white dark:bg-[#111111] border-b border-gray-200 dark:border-gray-800 shadow-sm relative">
  <div className="px-8 py-4 h-full flex flex-col">
    ...
    {/* Lime line separator */}
    <div className="h-[2px] bg-gray-100 dark:bg-[#1A1A1A] mt-2" />
  </div>
</div>

      {/* Mobile Dropdown Menu */}
      {menuOpen && (
        <div className="w-[1452px] md:hidden bg-white dark:bg-[#111111] border-b border-gray-200 dark:border-gray-800 px-8 py-4 flex flex-col gap-3">
          ...
          <div className="relative mt-1">
            <input
              ...
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="w-full border border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-[#1A1A1A] text-sm rounded-full py-2 pl-4 pr-10 focus:outline-none dark:text-white placeholder-gray-400"
            />
            <Search className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-400" />
          </div>
        </div>
      ...
      <div className="w-[1452px] px-[310px] mt-10">
        {/* Page Header */}
        <header className="mb-6">
          <h1 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-[#CEFF1B] tracking-tight mb-1">
            Active Projects
          </h1>
        ...
        {/* ── Contracts Card: EXACT 1089x386 ── */}
        <div className="w-[1089px] h-[386px] bg-white dark:bg-[#111111] border-2 border-gray-200 dark:border-[#CEFF1B] rounded-2xl overflow-hidden flex flex-col">
